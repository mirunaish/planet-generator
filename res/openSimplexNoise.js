 ...
 * license: The Unlicense: A license with no conditions whatsoever which
 * dedicates works to the public domain. Unlicensed works, modifications, and
 * larger works may be distributed under different terms and without source code
 * 
 * A JavaScript rewrite of typescript Open-Simplex-Noise an implementation of
 * OpenSimplex noise
 * 
 * The rewrite provides a 15-20% performance improvement on the typescript
 * implementation, file size reduction from 24.28K to 14.66K, and a reduced
